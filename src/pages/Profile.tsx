...
const Profile = () => {
  ...
  const recentActivities = [
    {
      type: "Investment",
      description: "SIP in Nifty 50 Index Fund",
      amount: "₹5,000",
      date: "Today",
      icon: TrendingUp,
    ...
    {
      type: "Dividend",
      description: "Received dividend from HDFC Mutual Fund",
      amount: "+₹1,250",
      date: "2 days ago",
      icon: Star,
    ...
    {
      type: "Achievement",
      description: "Completed 1 year of consistent SIP",
      amount: "🏆",
      date: "2 weeks ago",
      icon: Award,
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
            <div
              className={`bg-orange-500 h-2 rounded-full ${
                userData.riskScore <= 3
                  ? "w-3/10"
                  : userData.riskScore <= 5
                  ? "w-5/10"
                  : userData.riskScore <= 7
                  ? "w-7/10"
                  : userData.riskScore <= 8
                  ? "w-8/10"
                  : "w-9/10"
              }`}
            ></div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
            <div
              className={`bg-green-500 h-2 rounded-full ${
                userData.creditScore >= 800
                  ? "w-full"
                  : userData.creditScore >= 750
                  ? "w-11/12"
                  : userData.creditScore >= 700
                  ? "w-5/6"
