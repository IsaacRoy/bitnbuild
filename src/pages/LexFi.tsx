  ...
  const predictiveAlerts = [
    {
      ...
      title: "Balance Alert",
      message:
        "At this rate, your balance may hit zero before the month ends ⚠️",
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        ...
        <div className="h-48 mb-4">
          <svg width="100%" height="100%" viewBox="0 0 350 180">
            ...
            <line
              ...
              strokeDasharray="5,5"
            />
            <text x="325" y="165" fill="#ef4444" fontSize="12">
              ₹0
            </text>
            ...
            <path
              d={`M 30 ${
                160 -
                ((currentBalance - minValue) / (maxValue - minValue)) * 120
              } ${projectionData
                .map(
                  (value, index) =>
                    `L ${30 + (index + 1) * 10} ${
                      160 - ((value - minValue) / (maxValue - minValue)) * 120
                    }`
                )
                .join(" ")}`}
              fill="none"
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <p className="text-sm text-red-700">
            At current spending rate of ₹{dailySpending}/day, your balance will
            reach zero in approximately 16 days.
          </p>
        </div>
      </div>
    );
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  <h3 className={`font-bold ${alert.textColor}`}>
                    {alert.title}
                  </h3>
                ...
                <p className={`text-sm ${alert.textColor} mb-2`}>
                  {alert.message}
                </p>
        ...
        <div className="mt-4 p-3 bg-white/10 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium">
              AI is actively monitoring your finances
            </span>
          </div>
        </div>
      </div>
