...
const dummyGenieInsights: GenieInsight[] = [
  {
    ...
    message:
      "Hey! I noticed you spent 40% more on food delivery this week compared to last week. I get it - cooking can be exhausting sometimes! 😅",
    tone: "concerned",
    actionable_tip:
      "Maybe try cooking twice a week to save ₹1,500/month. Start with simple 15-minute meals!",
  ...
  },
  {
    ...
    message:
      "You're totally crushing it! Your coffee shop visits dropped by 30% this month. That discipline is paying off! ☕️",
    tone: "celebratory",
    actionable_tip:
      "Keep this momentum going! Maybe invest those savings in a nice coffee maker for home?",
  ...
  },
  {
    ...
    message:
      "Whoa there, shopping enthusiast! Your online purchases jumped 75% this week. Amazon Prime Day effect? 😄",
    tone: "friendly",
    actionable_tip:
      "Try the 24-hour rule: add items to cart, then wait a day before buying. You'll be surprised how often you change your mind!",
  ...
  },
  {
    ...
    message:
      "Love what I'm seeing! You switched to metro more often and cut Uber costs by 45%. Your wallet and the planet thank you! 🌱",
    tone: "celebratory",
    actionable_tip:
      "You're on fire! Consider getting a monthly metro pass for even more savings.",
  ...
  },
  {
    ...
    message:
      "Your entertainment spending is perfectly balanced - like all things should be! You're treating yourself without going overboard. 👏",
    tone: "motivational",
    actionable_tip:
      "This is the sweet spot! Maybe explore some free entertainment options to stretch your budget even further?",
  ...
  },
  {
    ...
    category: "Groceries",
    message:
      "Smart move! You've started buying groceries in bulk and saved 20% compared to frequent small trips. Efficiency level: Pro! 🛍️",
    tone: "celebratory",
    actionable_tip:
      "Plan your meals weekly to avoid food waste and save even more!",
        ...
        <div className="h-24 relative bg-gray-50 rounded-lg p-3">
          <svg className="w-full h-full" viewBox="0 0 300 60">
            ...
            <path
              d={lineData
                .map((point, index) => {
                  ...
                  const y =
                    50 -
                    ((point.amount - minValue) / (maxValue - minValue)) * 40;
            ...
            {lineData.map((point, index) => {
              const x = (index / (lineData.length - 1)) * 280 + 10;
              const y =
                50 - ((point.amount - minValue) / (maxValue - minValue)) * 40;
              return (
                <circle
                  key={index}
                  cx={x}
          ...
          <Card className="bg-gradient-to-r from-purple-500 to-pink-500 text-white">
            ...
            <CardContent>
              <p className="text-white/90 text-sm">
                Hey there! 🧞‍♂️ I'm your finance genie, here to explain your
                spending like your best friend would. Let's make sense of your
                money together!
              </p>
            </CardContent>
          </Card>
          ...
          {insights.map((insight) => (
            <Card key={insight.id} className="overflow-hidden">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <Badge
                      variant="outline"
                      className={getToneColor(insight.tone)}
                    >
                      {insight.tone}
                    </Badge>
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                {/* Actionable Tip */}
                <div
                  className={`p-4 rounded-lg border ${getToneColor(
                    insight.tone
                  )}`}
                >
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-white/90 text-sm">
                  ...
                  Your future self will thank you for every smart decision you
                  make today!
                </p>
              </div>
            </CardContent>
